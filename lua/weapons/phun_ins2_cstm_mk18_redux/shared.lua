...
SWEP.ViewModel = "models/gmod4phun/weapons/v_ins2_mk18_redux.mdl"
...
SWEP.IronsightPos = Vector(-2.546, -2.85, 0.565)
...
SWEP.VElements = {
	["carry_redux"] = {model = "models/gmod4phun/attachments/a_carryhandle_mk18_redux.mdl", default = true, bonemerge = true},
	["standard_redux"] = {model = "models/gmod4phun/attachments/a_standard2_mk18_redux.mdl", default = true, bonemerge = true},
	
	["standard2_redux"] = {model = "models/gmod4phun/attachments/a_standard_mk18_redux.mdl", bonemerge = true},
	
	["pb_ins2_cstm_att_ironsights"] = {model = "models/gmod4phun/ins2/upgrades/a_standard_mk18.mdl", bonemerge = true},
...
SWEP.DisableVElements = {
	["pb_ins2_cstm_att_ironsights"] = {"carry_redux"},
	["pb_ins2_att_optic_holo"] = {"carry_redux"},
	["pb_ins2_att_optic_reddot"] = {"carry_redux"},
	["pb_ins2_att_optic_2xreddot"] = {"carry_redux"},
	["pb_ins2_att_optic_elcan"] = {"carry_redux"},
}

SWEP.ReplaceVElements = {
	["pb_ins2_cstm_att_ironsights"] = {
		["standard_redux"] = "standard2_redux",
	},
}
...
SWEP.AttachmentIronsights = {
	["pb_ins2_cstm_att_ironsights"] = {pos = Vector(-2.546, -3.750, 0.745), ang = Vector(0.300, 0.050, 0.000)},
...
SWEP.Attachments = {
	[1] = {name = "Optics", attachments = {"pb_ins2_cstm_att_ironsights", "pb_ins2_att_optic_holo", "pb_ins2_att_optic_reddot", "pb_ins2_att_optic_2xreddot", "pb_ins2_att_optic_elcan"}},
...
local icon_merge_models = {
	SWEP.VElements.carry_redux.model,
	SWEP.VElements.standard_redux.model,
}

SWEP.INS2_IconParams = {dist = 13.5, offset = 0.1, spin = false, mergemodels = icon_merge_models}
