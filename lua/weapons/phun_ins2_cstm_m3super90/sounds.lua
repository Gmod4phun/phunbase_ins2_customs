-- PHUNBASE:addFireSound("PB_INS2_M590_FIRE", "weapons/toz_shotgun/toz_fp.wav", 1, 105, CHAN_STATIC)
-- PHUNBASE:addFireSound("PB_INS2_M590_FIRE_SUPPRESSED", "weapons/toz_shotgun/toz_suppressed_fp.wav", 1, 75, CHAN_STATIC)

-- PHUNBASE:addReloadSound("PB_INS2_M590_EMPTY", "weapons/toz_shotgun/handling/toz_empty.wav")
-- PHUNBASE:addReloadSound("PB_INS2_M590_PUMPBACK", "weapons/toz_shotgun/handling/toz_pumpback.wav")
-- PHUNBASE:addReloadSound("PB_INS2_M590_PUMPFORWARD", "weapons/toz_shotgun/handling/toz_pumpforward.wav")
