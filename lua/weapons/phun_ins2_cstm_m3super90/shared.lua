...
SWEP.VElements = {
	["standard"] = {model = "models/gmod4phun/attachments/a_standard_m3super90.mdl", default = true, bonemerge = true},
	...
	["pb_ins2_att_suppressor"] = {model = "models/gmod4phun/attachments/a_suppressor_glock20.mdl", bone = "A_Suppressor", pos = Vector(), angle = Angle(0,90,0), size = Vector(1.5,1.5,1.5), drawInRT = true},
...
SWEP.INS2_IconParams = {dist = 13, offset = -0.25, spin = false, mergemodels = icon_merge_models}
