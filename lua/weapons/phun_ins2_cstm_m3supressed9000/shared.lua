...
if !PHUNBASE.MAGIC then return end
...
SWEP.ViewModel = "models/gmod4phun/weapons/v_ins2_m3super90.mdl"
...
SWEP.IronsightPos = Vector(-2.010, -2.000, 0.698)
SWEP.IronsightAng = Vector(0.000, 0.040, 0.000)
...
SWEP.VElements = {
	...
	["pb_ins2_att_suppressor"] = {model = "models/gmod4phun/attachments/a_suppressor_glock20.mdl", bone = "A_Suppressor", pos = Vector(), angle = Angle(0,90,0), size = Vector(2,1.75,1.75), drawInRT = true},
	...
	["sup_shell_1"] = { model = "models/gmod4phun/attachments/a_suppressor_glock20.mdl", default = true, bone = "Shell", pos = Vector(0, 0.92, 0), angle = Angle(0, 90, 0), size = Vector(0.365, 0.699, 0.699)},
	["sup_shell_2"] = { model = "models/gmod4phun/attachments/a_suppressor_glock20.mdl", default = true, bone = "Shell_2", pos = Vector(0, 0.92, 0), angle = Angle(0, 90, 0), size = Vector(0.365, 0.699, 0.699)},
	
	["pump_shell"] = { model = "models/gmod4phun/attachments/a_suppressor_glock20.mdl", default = true, bone = "Pump", pos = Vector(0, 2.4, 0.219), angle = Angle(0, 90, 0), size = Vector(1, 2.099, 2.099)},
}
...
SWEP.ShellScale = 0.5
SWEP.ShellModel = SWEP.VElements.sup_shell_1.model
SWEP.NoShells = true
...
SWEP.INS2_IconParams = {dist = 13, offset = -0.25, spin = false}
