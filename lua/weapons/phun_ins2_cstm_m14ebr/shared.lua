...
SWEP.ViewModel = "models/gmod4phun/weapons/v_ins2_m14ebr.mdl"
...
SWEP.IronsightPos = Vector(-2.486, -1.750, 0.950)
SWEP.IronsightAng = Vector(0.000, 0.025, 0.000)
...
// shell-related stuff
SWEP.ShellVelocity = {X = 80, Y = 15, Z = 5}
...
SWEP.INS2_IconParams = {dist = 16.5, offset = 0.5, spin = false/*, mergemodels = icon_merge_models*/}
