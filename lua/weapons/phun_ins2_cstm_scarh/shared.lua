...
SWEP.ViewModel = "models/gmod4phun/weapons/v_ins2_scarh.mdl"
...
SWEP.IronsightPos = Vector(-2.743, -2.250, 0.705)
SWEP.IronsightAng = Vector(0.100, 0.025, 0.000)
...
SWEP.VElements = {
	...
	["standard_iron_up"] = {model = "models/gmod4phun/attachments/a_sights_scarh.mdl", bonemerge = true, default = true},
	["standard_iron_down"] = {model = "models/gmod4phun/attachments/a_sights_scarh.mdl", bonemerge = true, bodygroups = "1"},
}

local standard_irons = {
	["standard_iron_up"] = "standard_iron_down",
}
...
SWEP.ReplaceVElements = {
	...
	["pb_ins2_att_optic_holo"] = standard_irons,
	["pb_ins2_att_optic_reddot"] = standard_irons,
	["pb_ins2_att_optic_2xreddot"] = standard_irons,
	["pb_ins2_att_optic_elcan"] = standard_irons,
	["pb_ins2_att_optic_mk4"] = standard_irons,
	["pb_ins2_att_optic_kobra"] = standard_irons,
	["pb_ins2_att_optic_po4"] = standard_irons,
}
...
local icon_merge_models = {
	SWEP.VElements.standard_iron_up.model
}

SWEP.INS2_IconParams = {dist = 14.5, offset = -0.25, spin = false, mergemodels = icon_merge_models}
